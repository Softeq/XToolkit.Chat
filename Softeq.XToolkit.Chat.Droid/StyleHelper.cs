...
namespace Softeq.XToolkit.Chat.Droid
{
    ...
    {
        private static readonly Lazy<IChatDroidStyles> StyleLazy = ServiceLocator.LazyResolve<IChatDroidStyles>();

        public static IChatDroidStyles Style => StyleLazy.Value;
    }

    public interface IChatDroidStyles
    {
    ...
    public abstract class ChatDroidStylesBase : IChatDroidStyles
    {
